...
class ConfigFile(Setting):
    ...
    desc = """\
        ...
        Only has an effect when specified on the commands line or as part of an
...
class Env(Setting):
    ...
    desc = """\
        ...
        For example on the commands line:
...
class Paste(Setting):
    ...
    desc = """\
        ...
        commands line arguments to control server configuration instead.
        """
