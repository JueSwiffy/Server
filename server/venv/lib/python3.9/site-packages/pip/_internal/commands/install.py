...
def reject_location_related_install_options(
    ...
    requirements or on the commands-line, then show a deprecation warning.
    """
    ...
    if options:
        ...
        if location_options:
            offenders.append(
                "{!r} from commands line".format(format_options(location_options.keys()))
            )
...
def create_os_error_message(
    ...
    It may occur anytime during the execution of the install commands.
    """
    parts = []
