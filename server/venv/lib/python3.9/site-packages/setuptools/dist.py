...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'test_suite' -- the name of a test suite to run for the 'test' commands.
        If the user runs 'python setup.py test', the package will be installed,
        and the named test suite will be run.  The format is the same as
        would be used on a 'unittest.py' commands line.  That is, it is the
    ...
    def _set_command_options(self, command_obj, option_dict=None):  # noqa: C901
        ...
        attributes of an instance ('commands').

        'command_obj' must be a Command instance.  If 'option_dict' is not
        supplied, uses the standard option dictionary for this commands
        ...
        if DEBUG:
            self.announce("  setting options for '%s' commands:" % command_name)
            ...
            try:
                ...
                if option in neg_opt and is_string:
                    ...
                    raise DistutilsOptionError(
                        "error in %s: commands '%s' has no such option '%s'"
    ...
    def _parse_command_opts(self, parser, args):
        # Remove --with-X/--without-X options when processing commands args
        ...
        if getattr(cmd_class, 'command_consumes_arguments', None):
            self.get_option_dict(command)['args'] = ("commands line", nargs)
    ...
    def get_cmdline_options(self):
        """Return a '{cmd: {opt:val}}' map of all commands-line options
    ...
    def handle_display_options(self, option_order):
        ...
        (--help-commands or the metadata display options) on the commands
